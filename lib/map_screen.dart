...
class MapScreen extends StatefulWidget {
  // Definicja widżetu typu Stateful (ze stanem).
  const MapScreen({super.key}); // Konstruktor klasy.
  @override
  State<MapScreen> createState() =>
      _MapScreenState(); // Utworzenie stanu dla widżetu.
}

class _MapScreenState extends State<MapScreen> {
  // Klasa definiująca stan MapScreen.
  ...
  final TextEditingController loopDistanceController =
      TextEditingController(); // Kontroler tekstu dla dystansu pętli.
  ...
  void refreshPoint({String title = "", LatLng newPoint = const LatLng(0, 0)}) {
    setState(() {
          ...
          markers: [
            ...
            if (stop2 != null)
              Marker(
                ...
                height: 80,
                child:
                    const Icon(Icons.location_on, color: Colors.blue, size: 45),
              ),
            if (stop3 != null)
              Marker(
                point: stop3!,
        ...
        children: [
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    double loopDistance =
                        double.tryParse(loopDistanceController.text) ?? 0;
                    if (loopDistance > 0) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                            content:
                                Text('Wprowadź poprawny dystans dla pętli!')),
                      );
                    }
                  },
                ...
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    decoration:
                        const InputDecoration(labelText: 'Dystans pętli (km)'),
          ...
          Container(
            ...
            padding: const EdgeInsets.symmetric(
                vertical: 5, horizontal: 10), // Mniejsze odstępy
            child: Row(
              // Zmieniono Column na Row dla bardziej kompaktowego układu
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    minimumSize:
                        const Size(90, 40), // Zmniejszono rozmiar przycisku
                  ),
                  child: const Text('Zakończ trasę',
